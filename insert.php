        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <div class="container">
			<form action="insq.php" method="post" >
				<div class="row">
					<div class="form-group col">
						<label for="1">Date Actuelle</label>
						<input type="date" class="form-control" id="input" name="D1" value="">
					</div>
					<div class="form-group col">
						<label for="2">societe</label>
						<input type="text" class="form-control" id="input" name="D2" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="3">Agence maritime</label>
						<input type="time" class="form-control" id="input" name="D3" value="">
					</div>
					<div class="form-group col">
						<label for="4">Numbero BL</label>
						<input type="number" class="form-control" id="input" name="D4" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="5">Numbero CO</label>
						<input type="number" class="form-control" id="input" name="D5" value="">
					</div>
					<div class="form-group col">
						<label for="6">Date Reception BL</label>
						<input type="date" class="form-control" id="input" name="D6" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="7">Date Arrivee Co</label>
						<input type="date" class="form-control" id="input" name="D7" value="">
					</div>
					<div class="form-group col">
						<label for="8">Remaining Day Avant Arrivee CO</label>
						<input type="text" class="form-control" id="input" name="D8" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="9">Date DE Legalistation 7 Jours avant arrivee CO</label>
						<input type="date" class="form-control" id="input" name="D9" value="">
					</div>
					<div class="form-group col">
						<label for="10">Date De sortie CO Port Luanda 4 jours apres date arrivee</label>
						<input type="date" class="form-control" id="input" name="D10" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="11">Date DE Sortie Reelle</label>
						<input type="date" class="form-control" id="input" name="D11" value="">
					</div>
					<div class="form-group col">
						<label for="12">Jours DE Penalites Date DE Sortie Reelle Moins Date DE sortie Normale</label>
						<input type="date" class="form-control" id="input" name="D12" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="13">Date DE Retour CO</label>
						<input type="date" class="form-control" id="input" name="D13" value="">
					</div>
					<div class="form-group col">
						<label for="14">Date Reelle DE Retour CO</label>
						<input type="date" class="form-control" id="input" name="D14" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="15">Jours DE Penalites Date DE Retour CO Reelle Moins Date DE Retour Normale</label>
						<input type="date" class="form-control" id="input" name="D15" value="">
					</div>
					<div class="form-group col">
						<label for="16">Type DE</label>
						<input type="text" class="form-control" id="input" name="D16" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="17">POIDS</label>
						<input type="text" class="form-control" id="input" name="D17" value="">
					</div>
					<div class="form-group col">
						<label for="18">Nombre DE Colis</label>
						<input type="text" class="form-control" id="input" name="D18" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
						<label for="19">Nature marchandise</label>
						<input type="text" class="form-control" id="input" name="D19" value="">
					</div>
					<div class="form-group col">
						<label for="20">Camions DE Transport </label>
						<input type="text" class="form-control" id="input" name="D20" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
				...
				<div class="row">
					<div class="form-group col">
						...
						<input type="number" class="form-control" id="input" name="" value="">
					</div>
					<div class="form-group col">
				...
				<div class="row">
					...
					<div class="form-group col">
						...
						<input type="date" class="form-control" id="input" name="" value="">
					</div>
				</div>
				<div class="row">
					<div class="form-group col">
